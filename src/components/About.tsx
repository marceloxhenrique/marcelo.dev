...
const About = () => {
  return (
    <section
      id="ABOUT"
      className="my-32 flex  w-full flex-col items-center justify-center  p-4 pt-32 text-center font-sans lg:flex-row"
    >
      <article className="font-primary">
        <h1 className="pb-6 text-center text-4xl font-semibold md:text-5xl ">
          ABOUT
        </h1>
        <p className="max-w-4xl pb-6 text-left text-xl text-slate-600">
